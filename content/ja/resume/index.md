...
* 基本的な操作が可能で形状が複雑でないモデリング、簡単なUV展開、テクスチャ作成が可能
...
* [GDL](https://ja.wikipedia.org/wiki/GDL)で一定の入力に対してパラメトリックに変形、制御可能なオブジェクト（トイレ、ガレージ用門扉）を作成
* [MEP Modeler](https://graphisoft.com/jp/downloads/addons/mep)用の接続ポイントを埋め込んだ3Dモデルの作成
...
長期での育児休業を取得予定だったため引き継ぎ作業をおこないました。
